...
class ApiBillingAddress {
  ...
  Future<ResponseDto> addBillingAddress(String rfc, String businessName, String type, String address,
      String city, String postalCode, String outside, String inside, String stateId) async {
  ...
  Future<ResponseDto> updateBillingAddress(int id, String rfc, String businessName, String type, String address,
      String city, String postalCode, String outside, String inside, String stateId) async {
  ...
  Future<BillingAddress> showBillingAddress(int id) async {
    ...
    final decodedData = json.decode(response.body);
    final deliveryAddress = BillingAddress.fromJson(decodedData['deliveryAddres']);
